...
type LeasingHistoryRepository interface {
	...
	GetLeasingHistoryViaUser(id uuid.UUID) ([]domain.LeasingHistory, error)
	GetLeasingHistoryViaDorm(id uuid.UUID) ([]domain.LeasingHistory, error)
...
type LeasingHistoryHandler interface {
	...
	GetLeasingHistoryViaUser(c *fiber.Ctx) error
	GetLeasingHistoryViaDorm(c *fiber.Ctx) error
