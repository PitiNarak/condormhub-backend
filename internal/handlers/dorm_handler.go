...
// @Success 201  {object}  httpResponse.HttpResponse{data=domain.Dorm} "Dorm successfully created"
...
// @Success 200 {object} httpResponse.HttpResponse{data=nil} "Dorm successfully deleted"
