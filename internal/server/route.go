...
func (s *Server) initLeasingHistoryRoutes() {
	...
	historyRoutes.Post("/review", s.authMiddleware.Auth, s.handler.leasingHistory.CreateReview)
	historyRoutes.Patch("/review", s.authMiddleware.Auth, s.handler.leasingHistory.UpdateReview)
	historyRoutes.Delete("/review", s.authMiddleware.Auth, s.handler.leasingHistory.DeleteReview)
